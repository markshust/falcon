...
const ProductsCategoryLayout = themed({
  tag: 'div',
...
export const ProductsCategoryToolbar: React.SFC<{ sortOrders: any }> = ({ sortOrders }) => (
  ...
  <Query query={GET_PRODUCTS}>
    {data => (
      <ProductsCategoryLayout>
        ...
        <H1>Pots & Pans</H1>
        <ProductsCategoryToolbar sortOrders={data.sortOrders} />
        <Divider />
